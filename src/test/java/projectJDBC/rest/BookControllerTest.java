...
class BookControllerTest {
    ...
    void listPage() throws Exception {
        ...
        when(parsingDtoBook.bookToDtoBook(any())).thenReturn(new BookDto(ID_BOOK1, BOOK_NAME1, BOOK_YEAR1, NAME_AUTHOR1,
                YEAR_AUTHOR1, Collections.singletonList(GENRE_NAME1),null));

        List<BookDto> bookDtoList = new ArrayList<>();
        bookDtoList.add(parsingDtoBook.bookToDtoBook(any()));
