insert into author (id_author, author_name, year_author ) values (1, 'Pushkin', '1993-05-11');
insert into genre (id_genre, name_genre) values (1, 'drama');
insert into genre (id_genre, name_genre) values (2, 'horror');

insert into book (id_book, name_book, date_book,  id_author) values(1, 'evangelion', '1999-05-11', 1);
insert into book (name_book, date_book,  id_author) values ('eva', '1999-05-10', 1);
insert into book ( name_book, date_book,  id_author) values ('dota', '2008-09-12', 1);
